...
hadd "$outputPath"crab_TTToHadronic_TuneCP5_PSweights_13TeV-powheg-pythia8.root "$path"crab_TTToHadronic_TuneCP5_PSweights_13TeV-powheg-pythia8*
hadd "$outputPath"crab_WminusH_HToBB_WToQQ_M125_13TeV_powheg_pythia8.root "$path"crab_WminusH_HToBB_WToQQ_M125_13TeV_powheg_pythia8*
hadd "$outputPath"crab_WplusH_HToBB_WToLNu_M125_13TeV_powheg_pythia8.root "$path"crab_WplusH_HToBB_WToLNu_M125_13TeV_powheg_pythia8*
hadd "$outputPath"crab_ZH_HToBB_ZToLL_M125_13TeV_powheg_pythia8.root "$path"crab_ZH_HToBB_ZToLL_M125_13TeV_powheg_pythia8*
hadd "$outputPath"crab_ZH_HToBB_ZToNuNu_M125_13TeV_powheg_pythia8.root "$path"crab_ZH_HToBB_ZToNuNu_M125_13TeV_powheg_pythia8*
...
hadd "$outputPath"GJets_HT-200To400_TuneCP5_13TeV-madgraphMLM-pythia8.root "$path"GJets_HT-200To400_TuneCP5_13TeV-madgraphMLM-pythia8*
